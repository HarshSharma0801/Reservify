...
import PhotosApi from "./FormPhotosApi";
import { useNavigate } from "react-router";
import AddReserveApi from "./AddReserveApi";
...
const ReserveForm = () => {
  ...
  if (isDataReady) {
    AddReserveApi(formData , navigate);
  }

  const Sumitted = (e) => {
    e.preventDefault();
    SetisLoading(true);
    PhotosApi(FileInput, GetPhotosLink);
  ...
  return (
    ...
    {isLoading?  <Loader/> : ''}
     ...
     <form className="h-[100%] mt-10 mb-10" onSubmit={Sumitted}>
